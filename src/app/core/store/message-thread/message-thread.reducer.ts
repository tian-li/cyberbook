...
import { loginWithLocalTokenSuccess, logout } from '@cyberbook/core/store/user/user.actions';
...
export interface State extends EntityState<MessageThread> {
  selectedMessageThreadId: number | string | null;
}
...
const reducer = createReducer(
  ...
  // on(fromUser.loginSuccess, loginWithLocalTokenSuccess, (state, { messageThreads }) =>
  //   adapter.setAll(messageThreads, { ...state, selectedMessageThreadId: null })
  // ),
